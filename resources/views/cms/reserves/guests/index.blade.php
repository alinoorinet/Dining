...
@section('content')
    <div class="card mb-3">
        <div class="card-body">
            ...
            <h4 class="card-title">لیست رزروهای مهمانان</h4>
            <hr>
            <form id="guestResReportForm">
                <div class="row">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-2">
                        ...
                        <select class="custom-select @if($errors->has('meal'))is-invalid @endif" name="meal" id="meal" title="وعده">
                            <option value="صبحانه" selected>صبحانه</option>
                    ...
                    <div class="col-sm-2">
                        ...
                        <button type="button" class="btn btn-outline-success form-control" id="getGuestReportByDate">دریافت</button>
                    </div>
                </div>
            </form>
        </div>
...
@section('more_script')
    ...
    <script>
        ...
        $('#getGuestReportByDate').on('click',function () {
            ...
            $.ajax({
                cache: false,
                type: 'POST',
                url: '/home/reserves-report/guests',
                data: {
                    'beginDate' : beginDate,
                    'endDate'   : endDate,
                    'meal'      : meal,
        ...
        $('#dynamicContent').on('click',"#print",function () {
            $('#dynamicContent').print({
                globalStyles : true,
                mediaPrint : true,
