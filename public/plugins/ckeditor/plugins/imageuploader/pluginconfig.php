...
$username = "admin"; $password = 'cfcd208495d565ef66e7dff9f98764da';
   ...
   /* $useruploadfolder = "./uploads";
    ...
    $useruploadfolder = "/plugin/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "/plugin/ckeditor/plugins/imageuploader/uploads";
